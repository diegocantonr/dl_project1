...
def train_model(model, train_input, test_input, train_target, test_target, train_classes, test_classes, mini_batch_size=100, nb_epochs=25, criterion=nn.CrossEntropyLoss(), eta=.5, eta2=1e-2, alpha=.65, gamma=.75): 
    '''
...
def run_model(model_in, device, nb_samples=1000, nb_epochs=25, mini_batch_size=100, criterion=nn.CrossEntropyLoss(), eta=.5, eta2=1e-2, alpha=.65, gamma=.75, lossplot=False):
    '''
...
def compute_stats(models, nb_rounds=10, nb_samples=1000, nb_epochs=25, mini_batch_size=100, criterion=nn.CrossEntropyLoss(), eta=.5, eta2=1e-2, alpha=.65, gamma=.75, lossplot=False):
    '''
